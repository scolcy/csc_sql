...
# for spider1.0 test
DATASET_MODE="test"
DATAFILE_PATH="${DATASET_BASE_DIR}/spider1.0/test.json"
DATASET_PATH="${DATASET_BASE_DIR}/spider1.0/test_database"
TABLES_PATH="${DATASET_BASE_DIR}/spider1.0/test_tables.json"
SAVE_INDEX_PATH="${DATASET_BASE_DIR}/spider1.0/db_contents_index"
PROMPT_OUTPUT_PATH="${DATASET_BASE_DIR}/spider1.0/test_spider_prompt.json"
